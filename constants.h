...
#define VERTICAL_SCREEN_BUFFER_DOWN 8
#define VERTICAL_SCREEN_BUFFER_UP 24
#define HORIZONTAL_SCREEN_BUFFER_RIGHT 8
#define HORIZONTAL_SCREEN_BUFFER_LEFT 8
#define LEFT_SCROLL_STOP 192
